...
public class CouchbaseLitePlugin implements CBManagerDelegate {
  ...
  private final ReplicationEventListener3 mReplicationEventListener = new ReplicationEventListener3();
  private final ReplicationConflictResolverListener mReplicationConflictListener = new ReplicationConflictResolverListener();
  ...
  public static void registerWith(Registrar registrar) {
    ...
    new EventChannel(registrar.messenger(), CHARGING_CHANNEL).setStreamHandler(
            new EventChannel.StreamHandler() {

              @Override
              public void onListen(Object arguments, EventChannel.EventSink events) {
//                ReplicationConflictResolverListener.mEventSink=events;
                events.success("First Value");
              }
    ...
    final EventChannel replicationConflictResolverChannel = new EventChannel(registrar.messenger(), "com.saltechsystems.couchbase_lite/replicationConflictResolverChannel");
    replicationConflictResolverChannel.setStreamHandler(instance.mReplicationConflictListener);
    ...
    public void onMethodCall(MethodCall call, final Result result) {
      ...
      switch (call.method) {
        ...
        case ("storeReplicator"):
          ...
          ReplicatorConfiguration mReplicatorConfig;
          ReplicatorMap  replicatorMap = new ReplicatorMap(json);
          ...
          mReplicatorConfig.setConflictResolver(mReplicationConflictListener);

          final Replicator replicator = new ReplicatorJson(json,mCBManager,mReplicatorConfig).toCouchbaseReplicator();
...
//                mReplicationConflictListener.mEventSink.success("??????????");
