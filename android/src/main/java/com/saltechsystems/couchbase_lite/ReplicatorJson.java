...
class ReplicatorJson {
    ...
    private ReplicationConflictResolverListener mReplicationConflictListener;

    ReplicatorJson(JSONObject json, CBManager manager,ReplicatorConfiguration mReplicatorConfig) {
        this.mCBManager = manager;
        this.mReplicatorConfig = mReplicatorConfig;
...
////        mReplicatorConfig.setConflictResolver(new ReplicationConflictResolverListener());
