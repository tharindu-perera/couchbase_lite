...
class Replicator {
  ...
  static const MethodChannel _jsonChannel =  MethodChannel('com.saltechsystems.couchbase_lite/json', _jsonMethod);
  static const EventChannel _replicationEventChannel = EventChannel("com.saltechsystems.couchbase_lite/replicationEventChannel");
  static final Stream _replicationStream = _replicationEventChannel.receiveBroadcastStream();

  static const EventChannel _replicationConflictResolverChannel = EventChannel("com.saltechsystems.couchbase_lite/replicationConflictResolverChannel");

  static final Stream _replicationConflictResolverChannelStream = _replicationConflictResolverChannel.receiveBroadcastStream();
  ...
  ListenerToken addChangeListener(Function(ReplicatorChange) callback) {
    ...
    tokens[token] = _replicationStream .where((data) => (data["replicator"] == replicatorId &&  data["type"] == "ReplicatorChange"))
        .listen((data) {
  ...
  void addConflictResolveListener(Function(String) callback) {
    _replicationConflictResolverChannelStream .listen((data) {
