...
class Database {
  ...
  static const MethodChannel _methodChannel = MethodChannel('com.saltechsystems.couchbase_lite/database');

  static const EventChannel _eventChannel = EventChannel('com.saltechsystems.couchbase_lite/databaseEventChannel');
  ...
  static Future<Database> initWithName(String dbName) async {
    ...
    print(">>>>>>>DB init in database.dart");
    await _methodChannel.invokeMethod('initDatabaseWithName', <String, dynamic>{'database': dbName});
